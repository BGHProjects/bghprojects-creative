...
/**
 * Button that unselects the Generative AI Art item currently viewed
 * to return the user to the Generative AI Art page
 */
const GenAIArtBackButton = () => {
  const { setGenAIArtViewed } = useGenAIArtContext();

  const { functions } = useAppButton(0, () => {
    setGenAIArtViewed(GenAIArtViewed.None);
  });
...
export default GenAIArtBackButton;
